...
class Instalaciones : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(this,R.array.electro3, android.R.layout.simple_spinner_item).also{
    ...
    class SpinnerActivity : Activity(), AdapterView.OnItemSelectedListener{
        ...
        override fun onNothingSelected(p0: AdapterView<*>?) {
            Toast.makeText(applicationContext, "Debe seleccionar un electrodomestico",Toast.LENGTH_SHORT).show()
        }
    }
    private fun enviar(){
